        ...
        <section className="py-section-gap px-margin-page bg-[#020617] relative overflow-hidden">
          ...
          <div className="max-w-container-max mx-auto relative z-10">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="md:col-span-2 glass-card p-0 rounded-3xl group relative overflow-hidden border-primary/20 h-[500px]">
                <img src="/ads.png" alt="Meta Ads Automation" className="w-full h-full object-cover opacity-30 group-hover:opacity-50 transition-all duration-700" />
                <div className="absolute inset-0 bg-gradient-to-t from-[#020617] via-[#020617]/40 to-transparent"></div>
                <div className="absolute bottom-12 left-12 right-12">
                  <div className="mb-6 p-4 w-fit rounded-2xl bg-primary/10 border border-primary/20">
              ...
              <div className="glass-card p-12 rounded-3xl group relative overflow-hidden hover:bg-secondary/5 border-secondary/20 flex flex-col justify-center">
                <div className="mb-10 p-4 w-fit rounded-2xl bg-secondary/10 border border-secondary/20">
